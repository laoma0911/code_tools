...
public class MainBatchTableNameUserSQL {
	public static void main(String[] args) throws Exception {
		...
		String selectSql="select table_name from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA ='dayima' and table_name = 'ubaby_recommend_topic'";
